...
class BudgetTestCase(TestCase):
    ...
    def test_demo_private(self):
        # test redirection to /create when accessing demo project on a private instance
    ...
    def test_admin_authentication(self):
        ...
        self.assertIn('<a href="/authenticate_admin?goto=%2Fcreate">', resp.data.decode('utf-8'))

        # test right password
        resp = self.app.post("/authenticate_admin?goto=%2Fcreate", data={'admin_password': 'pass'})
        self.assertIn('<a href="/create">/create</a>', resp.data.decode('utf-8'))

        # test wrong password
        resp = self.app.post("/authenticate_admin?goto=%2Fcreate", data={'admin_password': 'wrong'})
